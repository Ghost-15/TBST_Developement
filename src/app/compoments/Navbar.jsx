    ...
    return (
        <nav className="bg-white border-gray-200">
            <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
                <a href="/ghost-15.github.io/TBST_Developement/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    <img src="/public/picture.jpg" className="h-12" alt="Logo"/>
