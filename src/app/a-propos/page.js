                    ...
                    <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
                        <div className='flex flex-col justify-center'>
                            <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>
                                Notre mission</h1>
                            <p className="text-xl">
                                Nous faisons du développement de logiciels professionnels pour votre entreprise afin
                                de relever avec succès le défi de la transformatoin numerique.
                                Nous nous efforcons a créer des logiciels les plus
                                puissants et les plus efficaces au monde.
                            </p>
                        </div>
